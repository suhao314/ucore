...
package Ada.Numerics is
   ...
   -- Scientific Toolworks: Removed declaration of Greek leter Pi
   --  until the full ISO/IEC 10646:2003 Universal Multiple-Octet
   --  Coded Character Set is being handled.  
