...
"x86_64-linux-thread-multi-2.6.18-308.24.1.el5" or
	die "Errno architecture (x86_64-linux-thread-multi-2.6.18-308.24.1.el5) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
